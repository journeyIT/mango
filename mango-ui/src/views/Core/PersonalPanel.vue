<template>
  <div class="personal-panel">
    ...
    <div class="personal-relation">
        <span class="relation-item fa fa-users"></span>
        <span class="relation-item fa fa-clock-o"></span>
        <span class="relation-item fa fa-handshake-o"></span>
    </div>
    <div class="main-operation">s
